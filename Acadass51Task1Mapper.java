...
public class Acadass51Task1Mapper  extends Mapper<LongWritable, Text, Text, IntWritable> {
...
private boolean recordIsBad(Text record) {
	...
	public void map(LongWritable key, Text value, Context context)
		...
		if (recordIsBad(value)) {
			...
			//3. Write a Map Reduce program to 
			//calculate the total units sold in each state for Onida company.
